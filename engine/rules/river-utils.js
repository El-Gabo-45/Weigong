 ...
 * Si el primer paso cae en el río, la pieza salta sobre él
 * (la casilla del río debe estar vacía). Si no, se mueve un paso normalmente.
 * Retorna el destino {r, c} si es alcanzable, o null si está bloqueado.
 */
export function applyRiverJump(board, r, c, dr, dc) {
  const step1r = r + dr;
  const step1c = c + dc;
 ...
 * es alcanzable mediante salto de río. Usado por las pruebas de ataque en check.js.
 */
export function testRiverJump(board, r, c, dr, dc, tr, tc) {

...
import { evaluate, computeFullHash, gamePhaseFactor } from '../ai/index.js';
import { buildAttackMap }  from '../ai/evaluation.js';
import { pieceSquareBonus } from '../ai/moves.js';
import { SIDE, BOARD_SIZE, isPalaceSquare } from '../constants.js';
